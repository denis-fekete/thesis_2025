...
\documentclass[english,enslovak,zadani]{fitthesis} % for submission to the IS VUT and/or print with color links - links are color
...
\projectinfo{
  ...
  date={May 12, 2026},             % datum odevzdání / submission date
  ...
  keywords.cs={hlboké neurálne siete, detekcia objektov, android, kotlin, yolo, augmentácia dát}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={deep neural networks, object detection, android, kotlin, yolo, data augmentation}, % klíčová slova v anglickém jazyce / keywords in english
  %keywords.en={Here, individual keywords separated by commas will be written in English.},
  % Abstrakt / Abstract
  abstract.cs={\input{00_sk_abstract}}, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
  abstract.en={\input{00_en_abstract}}, % abstrakt v anglickém jazyce / abstract in english
...
When working on the software, I used JetBrains IntelliJ IDEA’s Machine Learning-Assisted Completion and ChatGPT for non-semantic purposes and translation into the Czech language. Furthermore, Overleaf's built-in spelling checks were used during the writing of the thesis.},
...
% (externí zadavatel, konzultant apod.).},
  ...
  extendedabstract={\input{00_extended_absract}},
...
\begin{document}
  ...
  \ifenglish
    ...
    \input{02_previous}
    \input{03_computer_vision}
    \input{04_mobile_library}
    \input{05_dataset_creator}
    \input{06_bang_implementation}
